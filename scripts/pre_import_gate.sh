...
printf '\nRailYatra pre-import safety gate\n'
printf 'Project root: %s\n' "$ROOT_DIR"
printf 'Purpose: block real railway data writes unless all dry-run safety checks pass\n'
printf 'Database write mode: disabled\n'
...
run_step "Raw railway ingestion inspection" python3 scripts/smoke_ingestion.py
...
run_step "Frontend production build" scripts/smoke_frontend.sh

cleanup

printf '\n========================================\n'
printf 'PRE-IMPORT GATE RESULT: PASS\n'
printf 'Real railway data tables modified: no\n'
printf 'Database write skipped: yes\n'
printf 'frontend/dist removed\n'
printf 'Safe next action: manual review before any real import\n'
printf '========================================\n'
